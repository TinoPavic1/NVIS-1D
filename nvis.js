...
function latestfoF2(nvis) {  // current foF2 min max from Ionosondes
  var t=nvis.lat;
  var f1=2.5, f3=4.8;          // Mawson Station, Antarctica   
  if(t>-50) {f1=3.8; f3=6.8; } // Hobart
  if(t>-40) {f1=4.6; f3=8.8; } // Learmonth, Vic
  if(t>-36) {f1=4.47; f3=8.0; } // Canberra
  if(t>-34.5) {f1=4.7; f3=10.5; } // Camden, Sydney
  if(t>-32.5) {f1=4.2; f3=8.6; } // Perth
  if(t>-31) {f1=5.1;  f3=9.2;  } // Brisbane
  if(t>-23) {f1=5.3; f3=11.5; }    // Townsville
  if(t>-15) {f1=5.0; f3=13.0; }   // Darwin
  f2 = (f1+f3)/2;// adjust f2
  console.log("latestfoF2(), f1= " + f1.toFixed(1) + ",f3=" + f3.toFixed(1));
  // Mix with prediction
  var ye=2026, mo=4, da=0;    // date when Ionosonde adjusted  
