...
function latestfoF2(nvis) {  // current foF2 min max from Ionosondes
  ...
  if(t>-50) {f1=4.2; f3=11.0; } // Hobart
  if(t>-40) {f1=3.8; f3=12.5; } // Learmonth, Vic
  if(t>-36) {f1=4.5; f3=11.2; } // Canberra
  if(t>-34.5) {f1=4.2; f3=12.0; } // Camden, Sydney
  if(t>-32.5) {f1=4.2; f3=12.0; } // Perth
  if(t>-31) {f1=4.6;  f3=12.5;  } // Brisbane
  if(t>-23) {f1=3.6; f3=12.0; }    // Townsville
  if(t>-15) {f1=4.6; f3=17.5; }   // Darwin
  f2 = (f1+f3)/2;// adjust f2
  console.log("latestfoF2(), f1= " + f1.toFixed(1) + ",f3=" + f3.toFixed(1));
  // Mix with prediction
  var ye=2025, mo=4, da=30;   // date when Ionosonde adjusted  
