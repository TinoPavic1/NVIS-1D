...
function latestfoF2(nvis) {  // current foF2 min max from Ionosondes
  ...
  if(t>-50) {f1=2.9; f3=8.3; } // Hobart
  if(t>-40) {f1=3.4; f3=9.2; } // Learmonth, Vic
  if(t>-36) {f1=3.1; f3=8.3; } // Canberra
  if(t>-34.5) {f1=3.1; f3=9.0; } // Camden, Sydney
  if(t>-32.5) {f1=3.1; f3=9.0; } // Perth
  if(t>-31) {f1=4.0;  f3=8.3;  } // Brisbane
  if(t>-23) {f1=3.1; f3=8.8; }    // Townsville
  if(t>-15) {f1=4.0; f3=8.8; }   // Darwin
  f2 = (f1+f3)/2;// adjust f2
  console.log("latestfoF2(), f1= " + f1.toFixed(1) + ",f3=" + f3.toFixed(1));
  // Mix with prediction
  var ye=2025, mo=8, da=29;   // date when Ionosonde adjusted  
