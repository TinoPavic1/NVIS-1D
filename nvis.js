...
function latestfoF2(nvis) {  // current foF2 min max from Ionosondes
  var t=nvis.lat;
  var f1=3.2, f3=9.1;          // Mawson Station, Antarctica   
  if(t>-50) {f1=3.4; f3=7.1; } // Hobart
  if(t>-40) {f1=5.0; f3=10.5; } // Learmonth, Vic
  if(t>-36) {f1=4.4; f3=7.2; } // Canberra
  if(t>-34.5) {f1=4.1; f3=8.4; } // Camden, Sydney
  if(t>-32.5) {f1=4.1; f3=8.5; } // Perth
  if(t>-31) {f1=5.2;  f3=10.5;  } // Brisbane
  if(t>-23) {f1=4.7; f3=12.0; }    // Townsville
  if(t>-15) {f1=5.6; f3=12.2; }   // Darwin
  f2 = (f1+f3)/2;// adjust f2
  console.log("latestfoF2(), f1= " + f1.toFixed(1) + ",f3=" + f3.toFixed(1));
  // Mix with prediction
  var ye=2023, mo=10, da=24;   // date when Ionosonde adjusted  
